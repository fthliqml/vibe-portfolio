...
// Footer Logo Icon - Letter "F" stylized
export const FooterLogoIcon: React.FC<IconProps> = ({ className = 'w-6 h-6' }) => (
  <svg
    className={className}
    viewBox="0 0 24 24"
    fill="currentColor"
  >
    <path d="M7 2h12v2H9v7h8v2H9v9H7V2z" />
  </svg>
);
